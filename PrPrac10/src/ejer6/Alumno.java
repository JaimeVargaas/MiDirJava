...
public class Alumno implements Comparable<Alumno> {
	...
	/**
	 * M�todo que devuelve la informaci�n de un alumno de forma m�s detallada
	 * @return
	 */
	public String toStringCompleto() {
		return "\nNúmero de clase: " + this.numClase +
			   ...
			   "\nFecha de nacimiento (cualquier versión): " +
			                LibreriaFechas.getFechaFull(fecNac1) + 
			   "\nFecha de nacimiento (versión 8): " + 
	...
	public int compareTo(Alumno o) {
		int compara = this.getApellido1().compareTo(o.getApellido1());
		if (compara!=0)
			return compara;
		compara = this.getApellido2().compareTo(o.getApellido2());
		if (compara!=0)
			return compara;
		compara = this.getNombre().compareTo(o.getNombre());
		if (compara!=0)
			return compara;
